...
PRODUCT_COPY_FILES := \
	...
	device/sprd/sp8830ssw/media_codecs.xml:system/etc/media_codecs.xml \
	device/sprd/sp8830ssw/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/handheld_core_hardware_8830ec.xml:system/etc/permissions/handheld_core_hardware.xml \
