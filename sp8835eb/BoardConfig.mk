...
#KERNEL_DEFCONFIG := sp8835eb-native_defconfig
ifeq ($(TARGET_BUILD_VARIANT),user)
KERNEL_DEFCONFIG := sp8835eb-native_user_defconfig
else
KERNEL_DEFCONFIG := sp8835eb-native_defconfig
endif
...
BOARD_SYSTEMIMAGE_SPARSE_EXT_FLAG := true
