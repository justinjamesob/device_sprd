...
static inline void mali_set_div(int gpu_clock_div)
{
	MALI_DEBUG_PRINT(3,("GPU_DFS gpu_clock_div %d\n",gpu_clock_div));
	sci_glb_write(REG_GPU_APB_APB_CLK_CTRL,BITS_CLK_GPU_DIV(gpu_clock_div-1),BITS_CLK_GPU_DIV(3));
}
