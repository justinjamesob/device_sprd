...
extern int dumpImage(hwc_layer_list_t *list, int dumpFlag);

extern int dumpOverlayImage(struct overlay_setting *OverlayContext, struct overlay_setting *PrimaryContext, char *OverlayVirAddr, int dumpFlag);
