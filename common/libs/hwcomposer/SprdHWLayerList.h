...
public:
    ...
    inline void setAndroidLayer(hwc_layer_t *l)
    {
        mAndroidLayer = l;
    }

    inline hwc_layer_t *getAndroidLayer()
    {
...
public:
     ...
     * */
    bool updateGeometry(hwc_layer_list_t *list);
    ...
    bool checkHWLayerList(hwc_layer_list_t* list);
...
private:
    ...
    bool IsHWCLayer(hwc_layer_t *AndroidLayer);
     ...
     * */
    void ClearFrameBuffer(hwc_layer_t *l, unsigned int index);

    void dump_layer(hwc_layer_t const* l);
